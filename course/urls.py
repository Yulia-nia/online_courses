...
urlpatterns = [
    ...
    path('<int:id>/students_list/', views.StudentList.as_view(), name="students_list"),
    #path('create_notification/<int:s_id>/', views.create_notification, name='create_notification'),
